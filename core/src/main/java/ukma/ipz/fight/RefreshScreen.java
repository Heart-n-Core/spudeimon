...
//        player = new Fighter()
        ...
        FHN.description = "Гуманітарій — знавець людської \nдуші, історії, мови та мистецтва.\nЙого сила — у розумінні контексту,\nсмислів та ірраціональних \nмотивів, що керують людьми. \nВін здатен формувати наративи,\nщо змінюють світ.";
        factions.put(FI, Types.FI);
        factions.put(FHN, Types.FHN);
        Move FPVN = new Move(player, "ФПВН", 0);
        FPVN.description="Правник — вартовий правил,\nпорядку та справедливості.\nЙого сила — у знанні законів та\nвмінні використовувати їх для \nзахисту або атаки. Він діє у чітко\nвизначеній структурі, де логіка\nта формальні процедури\nмають вирішальне значення.";
        factions.put(FPVN, Types.FPVN);

        Move FPRN = new Move(player, "ФПРН", 0);
        FPRN.description = "Природничник —дослідник\nфундаментальних законів \nВсесвіту.\nЙого сила — в емпіричних доказах, експериментах\nта об'єктивній реальності. Він\nвідкриває істини, які не залежать\nвід людської думки чи \nсоціальних трендів";
        factions.put(FPRN, Types.FPRN);

        Move KMBS = new Move(player, "КМБС", 0);
        KMBS.description="Бізнесмен — це прагматичний\nстратег, лідер і творець\nцінності. Його сила— у здатності\nперетворювати ідеї на реальні,\nмасштабовані проекти,\nзалучати ресурси та ефективно\nуправляти ними для\nдосягнення мети.";
        factions.put(KMBS, Types.KMBS);

        Move FOZ = new Move(player, "ФОЗ", 0);
        FOZ.description="Цілитель — захисник фізичного\nта ментального здоров'я \nлюдини. Його сила — в емпатії,\nіндивідуальному підході та\nздатності рятувати життя і\nвідновлювати добробут.Він\nфокусується на конкретній людині\nтут і зараз.";
        factions.put(FOZ, Types.FOZ);

        Move FSNST = new Move(player, "ФСНСТ", 0);
        FSNST.description="Соціолог — аналітик суспільних\nнастроїв, групової динаміки\nта соціальних структур.\nЙого сила — у розумінні\nтого, як поводяться маси,\nяк народжуються і поширюються\nідеї та як можна впливати\nна громадську думку.";
        factions.put(FSNST, Types.FSNST);

        Move FEN = new Move(player, "ФЕН", 0);
        FEN.description="Економіст — майстер моделей\nпопиту та пропозиції,\nфінансових потоків та \nрозподілу ресурсів.\nЙого сила — у вмінні \nбачити світ через призму\nвартості, ефективності та\nсистемних взаємозв'язків.";
